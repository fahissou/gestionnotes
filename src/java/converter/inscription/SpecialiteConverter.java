 ...
 */
@FacesConverter("specialiteConverter")
public class SpecialiteConverter implements Converter{
    private static Map<String, Specialite> cache = new HashMap<>();
    @Override
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        String id = null;
        if (value instanceof Specialite) {
            Specialite model = (Specialite) value;
